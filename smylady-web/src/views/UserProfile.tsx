          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start gap-6 mt-4">
                <Link
                  href={`/user/${userId}/list?type=subscribers`}
                ...
                <Link
                  href={`/user/${userId}/list?type=following`}
                  className="text-center hover:text-primary transition-colors"
                >
        ...
        <div className="p-4 border-b flex items-center gap-3">
          {uploaderInfo && (
            <>
              <Avatar
                className="cursor-pointer"
                onClick={() => uploaderInfo._id && router.push(`/user/${uploaderInfo._id}`)}
              >
          ...
          <div className="p-4 border-b space-y-1">
            {memory.eventTitle && (
              <button
                ...
                onClick={() => memory.eventId && router.push(`/event/${generateEventSlug(memory.eventTitle || '', memory.eventId || '')}`)}
              >
                ...
                <div key={index} className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Avatar
                      ...
                      onClick={() => commentUserId && router.push(`/user/${commentUserId}`)}
                    >
                      <AvatarImage src={resolveImageUrl(commentUser?.profileImage)} />
                      <AvatarFallback className="text-xs">
                        {getInitials(commentUser?.name || '')}
                        ...
                        return (
                          <div key={replyIndex} className="flex gap-2">
                            <Avatar
                              ...
                              onClick={() => replyUserId && router.push(`/user/${replyUserId}`)}
                            >
                              <AvatarImage src={resolveImageUrl(replyUser?.profileImage)} />
                              <AvatarFallback className="text-xs">
                                {getInitials(replyUser?.name || '')}
