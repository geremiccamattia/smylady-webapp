...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "You're invited! Get €10 credit — Share Your Party",
    description: 'Sign up on Share Your Party and get €10 credit for events and tickets.',
    alternates: {
      canonical: url,
    ...
    openGraph: {
      ...
      description: 'Sign up now and we both get €10 credit.',
      url,
      type: 'website',
